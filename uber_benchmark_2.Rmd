...
As I mentioned, I believe this model does not capture all time-dependency pattersn in the data. Therefore, more sophisticated models are required. In the next notebook, I will investigate linear models with seasonality and harmonics. Stay tuned. 
